<!-- topics_list.tpl (templates/partials) //-->
		...
		<div class="col-md-7 col-sm-9 col-xs-10 content">
			<div class="avatar pull-left">
				...
				<div class="select" component="topic/select">
					<!-- IF topics.thumb -->
					<img src="{topics.thumb}" class="user-img" title="{topics.user.fullname}" />
					<!-- ELSE -->
					<!-- IF topics.user.picture -->
					<img component="user/picture" data-uid="{topics.user.uid}" src="{topics.user.picture}" class="user-img" title="{topics.user.fullname}" />
					<!-- ELSE -->
					<div class="user-icon" style="background-color: {topics.user.icon:bgColor};" title="{topics.user.fullname}">{topics.user.icon:text}</div>
			...
			<h2 component="topic/header" class="title">
				...
				<small>{topics.user.fullname}</small>
			...
			<div class="card" style="border-color: {topics.category.bgColor}">
				...
				<p>
					<a href="{config.relative_path}/user/{topics.teaser.user.userslug}">
						...
						<img title="{topics.teaser.user.fullname}" class="user-img" src="{topics.teaser.user.picture}" />
						<!-- ELSE -->
